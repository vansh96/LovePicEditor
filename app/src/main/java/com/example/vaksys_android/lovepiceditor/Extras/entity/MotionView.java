...
import com.example.vaksys_android.lovepiceditor.Extras.Multitouch.MoveGestureDetector;
import com.example.vaksys_android.lovepiceditor.Extras.Multitouch.RotateGestureDetector;
...
public class MotionView extends FrameLayout {
    ...
    private void initEntityBorder(@NonNull MotionEntity entity ) {
        ...
        borderPaint.setColor(ContextCompat.getColor(getContext(), R.color.transparant));
